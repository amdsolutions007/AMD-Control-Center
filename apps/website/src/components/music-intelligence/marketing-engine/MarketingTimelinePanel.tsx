import type { MarketingTimelineEvent } from '@/lib/music-intelligence/marketing-engine-types';

export default function MarketingTimelinePanel({ timeline }: { timeline: MarketingTimelineEvent[] }) {
  if (timeline.length === 0) {
    return <p className="text-sm text-gray-500">No marketing events recorded yet.</p>;
  }
  return (
