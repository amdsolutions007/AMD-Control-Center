...
function CircuitSVG({ uid }: { uid: string }) {
  ...
  const lP_desk = [
    ...
    `M 390,286 C 368,286 345,310 330,325 C 315,340 295,350 274,350`,
    `M 406,318 C 375,318 350,365 330,400 C 315,425 295,450 274,450`,
  ];
  const rP_desk = [
    ...
    `M 610,286 C 632,286 655,310 670,325 C 685,340 705,350 726,350`,
    `M 594,318 C 625,318 650,365 670,400 C 685,425 705,450 726,450`,
  ];
  ...
  const lP_mob = [
    ...
    `M 398,284 C 380,284 368,310 360,325 C 348,340 335,350 314,350`,
    `M 412,312 C 390,312 375,355 360,390 C 348,420 335,450 314,450`,
  ];
  const rP_mob = [
    ...
    `M 602,284 C 620,284 632,310 640,325 C 652,340 665,350 686,350`,
    `M 588,312 C 610,312 625,355 640,390 C 652,420 665,450 686,450`,
  ];
