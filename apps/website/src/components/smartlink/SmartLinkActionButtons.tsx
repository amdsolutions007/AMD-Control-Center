...
function CircuitSVG({ uid }: { uid: string }) {
  ...
  const lP_desk = [
    `M 406,182 C 375,182 350,135 330,100 C 315,75 300,50 284,50`,
    `M 390,214 C 368,214 345,190 330,175 C 315,160 300,150 284,150`,
    `M 384,250 C 360,250 345,250 330,250 C 315,250 300,250 284,250`,
    `M 390,286 C 368,286 345,310 330,325 C 315,340 300,350 284,350`,
    `M 406,318 C 375,318 350,365 330,400 C 315,425 300,450 284,450`,
  ];
  const rP_desk = [
    `M 594,182 C 625,182 650,135 670,100 C 685,75 700,50 716,50`,
    `M 610,214 C 632,214 655,190 670,175 C 685,160 700,150 716,150`,
    `M 616,250 C 640,250 655,250 670,250 C 685,250 700,250 716,250`,
    `M 610,286 C 632,286 655,310 670,325 C 685,340 700,350 716,350`,
    `M 594,318 C 625,318 650,365 670,400 C 685,425 700,450 716,450`,
  ];
  ...
  // Mobile Paths (Origins on R=104 circle, junctions at X=360/640, endpoints at X=324/676)
  const lP_mob = [
    `M 412,188 C 390,188 375,145 360,110 C 348,80 338,50 324,50`,
    `M 398,216 C 380,216 368,190 360,175 C 348,160 338,150 324,150`,
    `M 396,250 C 380,250 368,250 360,250 C 348,250 338,250 324,250`,
    `M 398,284 C 380,284 368,310 360,325 C 348,340 338,350 324,350`,
    `M 412,312 C 390,312 375,355 360,390 C 348,420 338,450 324,450`,
  ];
  const rP_mob = [
    `M 588,188 C 610,188 625,145 640,110 C 652,80 662,50 676,50`,
    `M 602,216 C 620,216 632,190 640,175 C 652,160 662,150 676,150`,
    `M 604,250 C 620,250 632,250 640,250 C 652,250 662,250 676,250`,
    `M 602,284 C 620,284 632,310 640,325 C 652,340 662,350 676,350`,
    `M 588,312 C 610,312 625,355 640,390 C 652,420 662,450 676,450`,
  ];
