export default function AMDCTABox() {
  ...
  return (
    <div className="my-16 p-12 border-2 border-amd-gold rounded-xl bg-gradient-to-br from-amd-gold/15 to-amd-gold/05 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-8 text-sm text-gray-400">
          <div className="flex items-center gap-2">
            <span className="text-amd-gold font-bold">127+</span>
            <span>Active Builders</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-amd-gold font-bold">37</span>
            <span>Nigerian States</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-amd-gold font-bold">Daily</span>
